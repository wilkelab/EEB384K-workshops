...
unzip main.zip
cd EEB384K-workshops-main/weeks11-12
```
...
Now everything is set up properly. Next go to VS Code and open the folder for weeks11-. (Do not open the parent folder! VS Code will not find the python virtual environment if you open the parent folder.) Then open the notebook `week11.ipynb` (for week 11) or `week12.ipynb` (for week 12) and follow the instructions there.
