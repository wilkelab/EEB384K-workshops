...
unzip main.zip
cd EEB384K-workshops-main/weeks13-14
```
...
Now everything is set up properly. Next go to VS Code and open the folder for weeks13-14. (Do not open the parent folder! VS Code will not find the python virtual environment if you open the parent folder.) Then open the notebook `week13.ipynb` (for week 13) or `week14.ipynb` (for week 14) and follow the instructions there.
